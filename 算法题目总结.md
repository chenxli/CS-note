...
616. 安排课程</a></td>
    ...
    <tr>
        <td rowspan="3">贪心</td>
        <td><a href="https://leetcode-cn.com/problems/minimum-number-of-arrows-to-burst-balloons/submissions/">LC452. 用最少数量的箭引爆气球</a></td>
        <td>中等⭐⭐⭐⭐⭐</td>
...
<table>
    ...
    <tr>
        ...
        <td>Top-down DP</td>
        <td>⭐⭐⭐</td>
        <td><a href="./code/1563. Stone Game V.cpp">cpp</a></td>
    </tr>
    <tr>
